...
public class QCommentLike extends EntityPathBase<CommentLike> {
    ...
    private static final long serialVersionUID = 1461708156L;
    ...
    public final com.sparta.easyspring.comment.entity.QComment comment;
    ...
    public QCommentLike(Class<? extends CommentLike> type, PathMetadata metadata, PathInits inits) {
        ...
        this.comment = inits.isInitialized("comment") ? new com.sparta.easyspring.comment.entity.QComment(forProperty("comment"), inits.get("comment")) : null;
